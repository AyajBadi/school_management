...
<body>
   ...
   <div class="enquiry">
    <form action="#" method="POST">
        <h1><center>Student Enquiry Form</center></h1>
        <label for="studentName">Student Name:</label>
        <input type="textbox" id="studentName" name="studentName" pattern="[A-Za-z\s]+" title="Only letters allowed" required>

        <label for="fatherName">Father Name:</label>
        <input type="textbox" id="fatherName" name="fatherName" pattern="[A-Za-z\s]+" title="Only letters allowed" required>
        ...
        <input type="textbox" id="address" name="address" required>
...
Saurashtra International School";
        $headers = "From: badiayaj2004@gmail.com";

        mail($to, $subject, $message, $headers);

        echo "<script>alert('Data Submitted and send mail');</script>";
    } else {
