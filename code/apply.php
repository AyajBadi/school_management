...
<div class="container">
    <form action="#" method="POST" enctype="multipart/form-data">
        ...
        <input type="textbox" id="fullname" name="fullname" pattern="[A-Za-z\s]+" title="Only letters allowed" required>
        ...
        <input type="textbox" id="previousschool" name="previousschool" required>
